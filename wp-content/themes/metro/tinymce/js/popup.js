	...
	$('#om_tmce_insert_button').click(function(){
		...
		switch (type) {
			...
			case 'recent_posts':
				...
				code_start='[recent_posts count="'+count+'"'+(thumbnails?' thumbnails="true"':'')+(thumbnails_align?' thumbnails_align="'+thumbnails_align+'"':'')+(thumbnails_first_big?' thumbnails_first_big="true"':'')+(category!=0?' category="'+category+'"':'')+(category_title?' category_title="true"':'')+']';
				code_end='';
			...
			case 'portfolio':
				...
				code_start='[recent_portfolios count="'+count+'"'+(category!=0?' category="'+category+'"':'')+']';
				code_end='';
